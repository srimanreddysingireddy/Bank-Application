...
<body>
    ...
    <h1 style="color: brown;">Close Form</h1>
    <br><br>
    <form action="/closefrom">
        <table>
            <tr>
                <td>
                    Account Number:
            ...
            <tr>
                <td><input type="checkbox" value="active" name="status">Active</td>
                <td><input type="checkbox" value="inactive" name="status">InActive</td>
            </tr>
            <tr>
                <td>
